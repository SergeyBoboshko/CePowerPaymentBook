...
fun ScaffoldTopCommon() {
    ...
    TopAppBar(
        ...
        title = { Text(text = stringResource(io.github.sergeyboboshko.ceppb.R.string.app_name)) },
        navigationIcon = {
            //------------------------- RETURN ICON ---------------------------------
...
//                        }
            ...
            if (showEscapeDialog) {
                SimpleAlertDialog(
                    ...
                    onConfirmation = {
                        val currBlockCleans = GlobalContext.mainViewModel?.blockCleans
                            ?: false//save for return statuse if user will want to open settings after popBackStack
                        navController?.popBackStack(mainCustomStack)
...
//            }
            IconButton(onClick = {
                ...
                Icon(
                    ...
                    contentDescription = "Settings"/*, tint = GlobalColors.currentPalette.text*/
                )
            }
        }
    )
