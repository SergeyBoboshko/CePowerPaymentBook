...
@ObjectGeneratorCE(type = GeneratorType.Reference, label = "Addresses")
@Parcelize
...
class RefAddressesEntity(
    ...
    @FormFieldCE (label = "@@zipCode_label", placeHolder = "@@zipCode_placeholder",type= FieldTypeHelper.TEXT, positionOnForm = 5, useForOrder = true, renderInList = false)
    var zipCode:String,
